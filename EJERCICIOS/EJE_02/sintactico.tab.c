...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OPENKEY = 4,                    /* OPENKEY  */
  YYSYMBOL_CLOSEKEY = 5,                   /* CLOSEKEY  */
  YYSYMBOL_EOL = 6,                        /* EOL  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMERO", "OPENKEY",
  "CLOSEKEY", "EOL", "$accept", "statement_list", "statement",
